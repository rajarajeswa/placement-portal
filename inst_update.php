...
<body>
    ...
    <div class="container mx-auto">
        <div class="row py-3 ">
            <h3 class="text-center">Update placed students</h3>
        </div>
        <div class="row">
            ...
            <form class="py-3" method="POST">
                <div class="card w-75 mx-auto py-3 shadow-lg">
                    ...
                    <label for="name" class="text-center">Batch</label>
                    <input type="text" class="form-control w-25 mx-auto" name="batch">

                    <label for="name" class="text-center">Department</label>
                    <input type="text" class="form-control w-25 mx-auto" name="dept">
                    <label for="name" class="text-center">Placed company</label>
                    <input type="text" class="form-control w-25 mx-auto" name="company">
    ...
    if (isset($_POST['submit'])) {
        ...
        $res = mysqli_query($db, "INSERT INTO placed (name, regno,batch, dept, company) VALUES ('$_POST[name]', '$_POST[regno]', '$_POST[batch]', '$_POST[dept]', '$_POST[company]')");
        if ($res) {
