...
<body>
    ...
    <div class="container mx-auto">
        <div class="row py-3 ">
            <h3 class="text-center">Update upcoming interview</h3>
        </div>
        <div class="row">

            <form class="py-3" method="POST">
                <div class="card w-75 mx-auto py-3 shadow-lg">
                    <label for="name" class="text-center">Company name</label>
                    <input type="text" class="form-control w-25 mx-auto" name="name">
                    <label for="name" class="text-center"> Company Location</label>
                    <input type="text" class="form-control w-25 mx-auto" name="loc">
                    <label for="name" class="text-center">Date of interview</label>
                    <input type="date" class="form-control w-25 mx-auto" name="date_int">

                    <label for="name" class="text-center">Departments expected</label>
                    <input type="text" class="form-control w-25 mx-auto" name="dept">
                    <label for="name" class="text-center">Venue</label>
                    <input type="text" class="form-control w-25 mx-auto" name="venue">
    ...
    if (isset($_POST['submit'])) {
        ...
        $res = mysqli_query($db, "INSERT INTO interview (name, loc,date_int, dept, venue) VALUES ('$_POST[name]', '$_POST[loc]', '$_POST[date_int]', '$_POST[dept]', '$_POST[venue]')");
        if ($res) {
